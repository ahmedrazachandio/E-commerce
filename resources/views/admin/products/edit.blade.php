        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="product_name" value="{{$product->product_name}}" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="sku" value="{{$product->sku}}" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="description" value="{{$product->description}}" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="price" value="{{$product->price}}" class="form-control form-control-lg form-control-solid"
            ...
            <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="featured" value="{{$product->featured}}" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row" >
                            <select name="status" value="{{$product->status}}" id="status" data-control="select2" class="form-select form-select-solid form-select-lg" required>
