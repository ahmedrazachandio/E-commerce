                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="title" value="{{$category->title}}" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="slug" value="{{$category->slug}}" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row" >
                            <select name="status" value="{{$category->status}}" id="status" class="form-control" required>
